...
public class ManageMenu extends JPanel {
	...
	class HallsFromCinemaComboBox extends JComboBox<Hall> {

		public HallsFromCinemaComboBox(Cinema c) {
			...
			addPopupMenuListener(new PopupMenuListener() {
				...
				public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
					try {
						updateModel(Main.applet.getSQLHandler().getHallsFromCinema(c));
					} catch (SQLException e1) {
						e1.printStackTrace();
					}
				}
		...
		public HallsFromCinemaComboBox() {
			...
			addPopupMenuListener(new PopupMenuListener() {
				...
				public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
					try {
						updateModel(Main.applet.getSQLHandler().getAllHalls());
					} catch (SQLException e1) {
						e1.printStackTrace();
					}
				}
	...
	class RemoveHallPanel extends JPanel {
		...
		private CinemaComboBox ccb;
		private HallsFromCinemaComboBox hccb;
		private JButton removeButton;
		...
		public RemoveHallPanel() {
			...
			hccb = new HallsFromCinemaComboBox();
